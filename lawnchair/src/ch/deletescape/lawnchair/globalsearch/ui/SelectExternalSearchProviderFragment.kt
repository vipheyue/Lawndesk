...
class SelectExternalSearchProviderFragment : PreferenceDialogFragmentCompat() {
    ...
    inner class ProviderListAdapter(private val context: Context) : RecyclerView.Adapter<ProviderListAdapter.Holder>() {
        ...
        val Providers = ExternalSearchProviderController.getExternalSearchProviders(context)
    ...
    companion object {
        ...
        fun newInstance(preference: ExternalSearchProviderPreference) = SelectExternalSearchProviderFragment().apply {
